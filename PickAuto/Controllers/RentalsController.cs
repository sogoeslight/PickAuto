...
namespace PickAuto.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RentalId,CarId,RentalRate,RentalStart,RentalEnd,WorkerId,CustomerId,PaymentDate")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RentalId,CarId,RentalRate,RentalStart,RentalEnd,WorkerId,CustomerId,PaymentDate")] Rental rental)
        {
