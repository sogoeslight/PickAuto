...
namespace PickAuto.Controllers
{
    public class StoresController : Controller
    {
        ...
        public StoresController(PickAutoContext context)
        {
            _context = context;
        }
        ...
        {
            var pickAutoContext = _context.Store.Include(s => s.Address);
        ...
        {
            ViewData["StoreId"] = new SelectList(_context.Address, "AddressId", "AddressLine1");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("StoreId,Name")] Store store)
        {
            ...
            ViewData["StoreId"] = new SelectList(_context.Address, "AddressId", "AddressLine1", store.StoreId);
            return View(store);
        }
