...
namespace PickAuto.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PurchaseId,CarId,Price,WorkerId,CustomerId,PaymentDate")] Purchase purchase)
        {
            ...
            ViewData["CarId"] = new SelectList(_context.Car, "CarId", "CarId", purchase.CarId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PurchaseId,CarId,Price,WorkerId,CustomerId,PaymentDate")] Purchase purchase)
        {
